from vtkmodules.vtkCommonDataModel import vtkUnstructuredGrid, vtkPolygon, VTK_POLYHEDRON, vtkTetra, vtkVertex
from vtkmodules.vtkCommonCore import vtkPoints, vtkIdList


def generate_point_grid(point_1=(0, 0, 0)):
    ...
    u_grid.InsertNextCell(vertex.GetCellType(), vertex.GetPointIds())
