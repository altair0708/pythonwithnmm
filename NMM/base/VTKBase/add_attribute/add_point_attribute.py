...
class AddPointAttribute(FunctionAddAttribute):
    ...
    def add_int_array(vtk_model: vtkUnstructuredGrid, attribute_name: str, tuple_dimensional: int, is_id=False):
        ...
        [array.InsertTuple(i, initial_data(i)) for i in range(vtk_model.GetNumberOfPoints())]
        vtk_model.GetPointData().AddArray(array)
    ...
    def add_float_array(vtk_model: vtkUnstructuredGrid, attribute_name: str, tuple_dimensional: int, is_id=False):
        ...
        [array.InsertTuple(i, initial_data) for i in range(vtk_model.GetNumberOfPoints())]
        vtk_model.GetPointData().AddArray(array)
