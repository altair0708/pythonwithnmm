...
from NMM.base.Command.ModelCommand.ModelAddSpecialPoint import ModelAddSpecialPoint
...
invoker.set_command(ModelAddSpecialPoint())
invoker.set_command(ModelAddAttribute('boundary_condition', 'cell_id', data_structure))
