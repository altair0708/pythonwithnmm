...
for each_point_id in range(1922):
...
for each_row in range(31):
    for each_col in range(31):
        x = 0 + (4 / 30) * each_col
        y = -1 + (2 / 30) * each_row
        z_0 = 9.9
        z_1 = -9.9
...
[point_type.InsertValue(i, 1) for i in range(1922)]
