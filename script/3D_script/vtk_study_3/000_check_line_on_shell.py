...
def is_point_on_surface(point, surface, tolerance=1e-5):
...
def check_line_endpoints_on_surface(surface_polydata, line_grid, tolerance=1e-4):
...
def main():
    ...
    for each_line in lines:
        result = check_line_endpoints_on_surface(shell, each_line, tolerance)
