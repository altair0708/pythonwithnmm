...
for z in range(layer_point_number):
    for y in range(column_point_number):
        for x in range(row_point_number):
            ...
            point_coord_list.InsertPoint(point_id, (x * point_distance, y * point_distance, z * point_distance))
...
point_writer.SetFileName('re023_1.vtu')
...
element_writer.SetFileName('re023_2.vtu')
...
tetra_writer.SetFileName('re023_3.vtu')
...
tetra_polyhedron_writer.SetFileName('re023_5.vtu')
...
clipper_writer.SetFileName('re023_6.vtu')
...
math_cover_writer.SetFileName('re023_4.vtu')
