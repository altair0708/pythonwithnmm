...
class PATH:
    ...
    mathcover_file = './geometry/math_cover.vtu'
    crack_file = './geometry/crack_surface.vtu'
    database_name = './geometry/manifold_mathcover.db'
    special_point_file = './mesh/special_point.vtu'
...
for step in range(5):
    ...
    ElementIOer3D.write_vtk_model(data_structure.special_point, path_file=PATH)
