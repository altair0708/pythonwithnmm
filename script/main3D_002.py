...
from NMM.crack_3D.operation.ElementCrack3D import ElementCracker3D
...
for step in range(1):
    ...
    old_matrix_save(stiff_matrix.toarray(), 'total_matrix')
    old_matrix_save(force_vector, 'total_force')
    old_matrix_save(x, 'displacement_vector')
