...
class SimplePointGenerator:
    ...
    def update(self):
        ...
        temp_point.GetPointIds().InsertId(0, temp_point_id)
        special_point_grid.InsertNextCell(temp_point.GetCellType(), temp_point.GetPointIds())
        special_points_coordinate.InsertNextPoint((coordinate[0], coordinate[1], coordinate[2]))

        # id = 0 loading point
        # id = 1 fixed point
        # id = 2 measured point
        point_group_value = self.__point_group_value
        point_group.InsertNextValue(point_group_value)

        point_type_value = self.__point_type_value
        point_type.InsertNextValue(point_type_value)

        # fixed direction: (0, 0, 1) mean to fixed z.
        fixed_type_value = self.__fixed_type_value
        fixed_type.InsertNextTuple(fixed_type_value)

        # fixed point: velocity
        point_velocity_value = self.__point_velocity_value
        point_velocity.InsertNextTuple(point_velocity_value)

        # loading point: loading force
        point_force_value = self.__point_force_value
        point_force.InsertNextTuple(point_force_value)
...
# generator.origin = (1, -1, -1)
# generator.size = (0, 2, 2)
# generator.number = (1, 11, 11)
# generator.point_group_value = 0
# generator.fixed_type_value = (1, 0, 0)
# generator.point_type_value = 1
# generator.point_velocity_value = (0, 0, 0)
# generator.update()

simple_generator = SimplePointGenerator()
simple_generator.coordinate = (0, 0, 0)
simple_generator.point_group_value = 0
simple_generator.fixed_type_value = (0, 0, 1)
simple_generator.point_type_value = 1
simple_generator.point_velocity_value = (0, 0, 0)
simple_generator.update()

simple_generator.coordinate = (1, 0, 0)
simple_generator.point_group_value = 0
simple_generator.fixed_type_value = (0, 0, 1)
simple_generator.point_type_value = 1
simple_generator.point_velocity_value = (0, 0, 0)
...
simple_generator.coordinate = (0, 1, 0)
simple_generator.point_group_value = 0
simple_generator.fixed_type_value = (0, 0, 1)
simple_generator.point_type_value = 1
simple_generator.point_velocity_value = (0, 0, 0)
...
# simple_generator.coordinate = (0, 0, 1)
# simple_generator.point_group_value = 0
# simple_generator.point_type_value = 0
# simple_generator.point_force_value = (1, 0, 0)
# simple_generator.update()
